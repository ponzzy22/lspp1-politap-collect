...
@endsection
@section('css')
    <link rel="stylesheet" href="{{ asset('client/css/Pemegegang-Sertifikat.css') }}" media="screen">
@endsection
@section('isi')
                            ...
                            <div class="u-container-layout u-valign-middle u-container-layout-1">
                                <h1 class="u-custom-font u-font-merriweather u-text u-text-default u-title u-text-1"
                                    data-animation-name="customAnimationIn" data-animation-duration="1000"><span
                                        class="u-file-icon u-icon u-text-white u-icon-1"><img src="{{ asset('images/logo2/18.png') }}"
