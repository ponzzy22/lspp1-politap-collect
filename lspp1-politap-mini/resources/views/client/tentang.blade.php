...
@endsection
@section('css')
    <link rel="stylesheet" href="{{ asset('client/css/Tentang.css') }}" media="screen">
@endsection
@section('isi')
                            ...
                            <div class="u-container-layout u-valign-middle-xs u-container-layout-1">
                                <h1 class="u-custom-font u-font-merriweather u-text u-text-default u-title u-text-1"
                                    ...
                                    data-animation-direction=""><span class="u-file-icon u-icon u-text-white u-icon-1"><img
                                            src="{{ asset('images/logo2/12.png') }}" alt=""></span>&nbsp;Tentang
                                    LSP - POLITAP
                                </h1>
                            </div>
                        </div>
    ...
    <section class="u-clearfix u-grey-10 u-section-2" id="sec-7530">
        <div class="u-clearfix u-sheet u-sheet-1">
            <div style="background-image: url('{{ asset('images/logo2/sdsd.png') }}')"
