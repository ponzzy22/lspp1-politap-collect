...
@endsection
@section('css')
    <link rel="stylesheet" href="{{ asset('client/css/Galeri.css') }}" media="screen">
@endsection
@section('isi')
                            ...
                            <div
                                ...
                                <h1 class="u-custom-font u-font-merriweather u-text u-text-default u-title u-text-1"><span
                                        class="u-file-icon u-icon u-text-white u-icon-1"><img
                                            src="{{ asset('images/logo/16.png') }}" alt=""></span>&nbsp;Album
                                    Galery
                                </h1>
                            </div>
                        </div>
            ...
            <div class="u-expanded-width u-layout-horizontal u-list u-list-1">
                <div class="u-repeater u-repeater-1">
                    @foreach ($galeri as $asu)
                        <div style="background-image: url('images/logo/placeholder_image1.png')" class="u-align-center u-container-style u-image u-image-round u-list-item u-radius-24 u-repeater-item u-shading u-image-1"
