...
<head>
    ...
    <meta charset="utf-8">
    <meta name="keywords"
        content="LEMBAGA SERTIFIKASI PROFESI PIHAK KESATU - POLITEKNIK NEGERI KETAPANG, ​&nbsp;Detail Album">
    <meta name="description" content="">
    <title>@yield('judul')</title>
    <link rel="shortcut icon" href="{{ asset('assets/images/logo/lsp.png') }}" />
    @yield('css')
    <link rel="stylesheet" href="{{ asset('client/css/nicepage.css') }}" media="screen">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    <script class="u-script" type="text/javascript" src="{{ asset('client/js/jquery.js') }}" defer=""></script>
    <script class="u-script" type="text/javascript" src="{{ asset('client/js/nicepage.js') }}" defer=""></script>
    <meta name="generator" content="Nicepage 4.12.5, nicepage.com">
    <link id="u-theme-google-font" rel="stylesheet"
        href="https://fonts.googleapis.com/css?family=Roboto:100,100i,300,300i,400,400i,500,500i,700,700i,900,900i|Open+Sans:300,300i,400,400i,500,500i,600,600i,700,700i,800,800i">
    <link id="u-page-google-font" rel="stylesheet"
        href="https://fonts.googleapis.com/css?family=Merriweather:300,300i,400,400i,700,700i,900,900i|Ubuntu:300,300i,400,400i,500,500i,700,700i">
    ...
    <meta name="twitter:title" content="Detail Album">
    <meta name="twitter:description" content="">
    <meta property="og:title" content="Detail Album">
...
<body class="u-body u-xl-mode">
    ...
    <footer class="u-align-center u-clearfix u-footer u-grey-90 u-footer" id="sec-df38">
        <div class="u-clearfix u-sheet u-sheet-1">
            <p class="u-small-text u-text u-text-custom-color-3 u-text-variant u-text-1"> Copyright
                © 2022
                ♦
            ...
            <p class="u-small-text u-text u-text-custom-color-3 u-text-variant u-text-2"> Hand-crafted
                &amp; made
                with <i></i>
