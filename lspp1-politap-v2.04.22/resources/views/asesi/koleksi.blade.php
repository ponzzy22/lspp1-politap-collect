                ...
                <div class="row">
                    ...
                    <thead>
                        <tr class="bg-danger text-white" role="row">
                            ...
                            <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Ship to: activate to sort column ascending" style="width: 97.5469px;">Tanggal</th>
                        </tr>
                    </thead>
                    <tbody>
