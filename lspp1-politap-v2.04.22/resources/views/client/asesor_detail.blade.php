...
@endsection
@section('css')
    <link rel="stylesheet" href="{{ asset('public/client/css/Detail-Asesor.css') }}">
@endsection
@section('isi')
    <section style="background-image: url('{{ asset('public/images/back/1.jpg') }}')" class="u-clearfix u-image u-section-1" id="carousel_6766" data-image-width="1600" data-image-height="1067">
