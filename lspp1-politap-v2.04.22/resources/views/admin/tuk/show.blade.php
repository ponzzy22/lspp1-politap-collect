...
<div class="accordion accordion-solid-header" id="accordion-4" role="tablist">
    <div class="card">
        ...
        <div id="collapse-11" class="collapse" role="tabpanel" aria-labelledby="heading-11"
            ...
            <div class="card-body">
                <form action="{{ route('tuk.update', $tuk->id) }}" enctype="multipart/form-data" method="POST" class="form-sample">
                    @csrf
                    @method('put')
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="{{ $tuk->pengelola }}" maxlength="100" name="pengelola"
                                        class="form-control" />
                                    @error('pengelola')
                                        <div class="text-danger mt-2 text-sm">{{ $message }}</div>
                                    @enderror
